<div>
    ...
    'breadcrumbItems' => [
    ['text' => 'ADM', 'url' => ''] ,['text' => 'Landing', 'url' => '/landing'] ,['text' => 'Forms', 'url' => ''] ,['text' => 'CSTform', 'url' => '/cstform']
    ],
    ])
                    ...
                    <form wire:submit.prevent="updateForm">
                        ...
                        <div class="button-group">
                            <div class="button-group-left">
                                <h5 style="background-color:#00FF9C; border-radius:5px; color:black;padding:12px;margin-top:-2px">CSTform</h5>
                                <a href="/cstform">
                        ...
                        <div class="form-row">
                            <div class="form-group date-field">
                                <label>Date</label>
                                <input type="date" class="form-control1" wire:model="formData.candidate.date_cst">
                                @error('formData.date_cst') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>CSTcode</label>
                                <input type="text" class="form-control1" wire:model="formData.candidate.cst_code" readonly>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group objet-field">
                                <label>Status</label>
                                <select class="form-control1" wire:model="formData.candidate.status">
