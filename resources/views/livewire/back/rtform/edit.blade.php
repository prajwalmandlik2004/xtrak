                    ...
                    <form wire:submit.prevent="updateForm">
                        ...
                        <div class="button-group">
                            <div class="button-group-left">
                                <h5 style="background-color:red; border-radius:5px; color:white;padding:12px;margin-top:-2px">RTform</h5>
                                <a href="/rtform">
                        ...
                        <div class="form-row">
                            <div class="form-group date-field">
                                <label>Date</label>
                                <input type="date" class="form-control1" wire:model="formData.date_rt">
                                @error('date_rt') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>Auth.</label>
                                <select class="form-control1" wire:model="formData.auth">
                            ...
                            <div class="form-group objet-field">
                                <label>Tskcode</label>
                                <input type="text" class="form-control1" wire:model="formData.task_code">
                                @error('task_code') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>Dest.</label>
                                <input type="text" class="form-control1" wire:model="formData.destination">
                                @error('destination') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>Type Input</label>
                                <input type="text" class="form-control1" wire:model="formData.type_input">
                            </div>
                            <div class="form-group objet-field">
                                <label>Subject</label>
                                <input type="text" class="form-control1" wire:model="formData.subject">
                            </div>
                            <div class="form-group objet-field">
                                <label>Position</label>
                                <input type="text" class="form-control1" wire:model="formData.position">
                            </div>
                            <div class="form-group objet-field">
                                <label>Status</label>
                                <input type="text" class="form-control1" wire:model="formData.status">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group date-field">
                                <label>Re.</label>
                                <input type="text" class="form-control1" wire:model="formData.re">
                                @error('re') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>Rk</label>
                                <input type="text" class="form-control1" wire:model="formData.rk">
                            </div>
                            <div class="form-group objet-field">
                                <label>Problems</label>
                                <input type="text" class="form-control1" wire:model="formData.problems">
                                @error('problems') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>Delay</label>
                                <input type="text" class="form-control1" wire:model="formData.delay">
                            </div>
                            <div class="form-group objet-field">
                                <label>Remarks</label>
                            ...
                            <div class="form-group objet-field">
                                <label>Vol.</label>
                                <input type="text" class="form-control1" wire:model="formData.vol">
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group objet-field">
                                ...
                                <input type="text" class="form-control1" wire:model="formData.corrective_actions">
                                @error('corrective_actions') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group comment-field">
                                <label>Note1</label>
                                <textarea class="form-control2" wire:model="formData.note_one"></textarea>
                            </div>
                            <div class="form-group comment-field">
                                <label>Note2</label>
                                <textarea class="form-control2" wire:model="formData.note_two"></textarea>
                            </div>
                        </div>
