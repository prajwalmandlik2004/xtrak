                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="form-row">
                            <div class="form-group date-field">
                                <label>Date</label>
                                <input type="date" class="form-control1" wire:model="date_cst">
                                @error('date_cst') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group objet-field">
                                <label>Status</label>
                                <select class="form-control1" wire:model="status">
