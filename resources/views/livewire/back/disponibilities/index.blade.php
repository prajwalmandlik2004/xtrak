<div>
    ...
    @include('components.breadcrumb', [
        'title' => 'Listes des disponibilités',
        'breadcrumbItems' => [
            ['text' => 'disponibilités', 'url' => '#'],
            ['text' => 'Listes', 'url' => Route('disponibilities.index')],
        ],
    ])
    <!-- end page title -->
    <div class="d-flex">
    ...
    <div class="row g-0 text-center text-sm-start align-items-center mb-4">
        <!-- end col -->
        {{ $disponibilities->links() }}
    </div><!-- end row -->


    <x-modal>
        <x-slot name="title">
            {{ $isUpdate ? 'Modification de la disponibilité' : 'Ajout de la disponibilité' }}
        </x-slot>
        <x-slot name="body">
