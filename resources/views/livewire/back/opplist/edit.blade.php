<div>
    ...
    'breadcrumbItems' => [
    ['text' => 'ADM', 'url' => ''] ,['text' => 'Landing', 'url' => '/landing'] ,['text' => 'Forms', 'url' => ''] ,['text' => 'OPPform', 'url' => '/opportunity']
    ],
    ])
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-4">
                                                ...
                                                <div class="col-lg-2">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            wire:model="formData.opportunity.opportunity_date"
                                                ...
                                                <div class="col-lg-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.opp_code'
                                                            readonly />
                                                        @error('opp_code')
                                                ...
                                                <div class="col-lg-1">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control form-control-custom-1  @error('origine') is-invalid @enderror "
                                                            ...
                                                            wire:model="formData.opportunity.auth"
                                                            placeholder="auteur" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.trg_code'
                                                            placeholder="TRGCode" />
                                                        @error('trg_code')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-lg-auto">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.name'
                                                ...
                                                <div class="col-lg-1">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.postal_code_1'
                                                            placeholder="CP" />
                                                        @error('postal_code_1')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="mt-2 col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.ctc1_code'
                                                            placeholder="CTCcode" />
                                                        @error('ctc1_code')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="mt-2 col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.civs'
                                                            placeholder="Civ" />
                                                        @error('civs')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="mt-2 col-lg-2 ">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.ctc1_first_name'
                                                            placeholder="Prénom" />
                                                ...
                                                <div class="mt-2 col-lg-2 ">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.ctc1_last_name'
                                                            placeholder="Nom" />
                                                ...
                                                <div class="mt-2 col-lg-2 ">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.position'
                                                ...
                                                <div class="mt-2 col-lg-2 ">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.remarks'
                                    ...
                                    form-control-custom-1  @error('job_titles') is-invalid @enderror "
                                                            min="0" wire:model='formData.opportunity.job_titles'
                                    ...
                                    form-control-custom-1  @error('specificities') is-invalid @enderror "
                                                            min="0" wire:model='formData.opportunity.specificities'
                                    ...
                                    form-control-custom-1  @error('domain') is-invalid @enderror "
                                                            min="0" wire:model='formData.opportunity.domain'
                                                            placeholder="Domain" />
                                                        @error('domain')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                    ...
                                    form-control-custom-1  @error('postal_code') is-invalid @enderror "
                                                            min="0" wire:model='formData.opportunity.postal_code'
                                                            placeholder="CP/DPT" />
                                                        @error('postal_code')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                    ...
                                    form-control-custom-1  @error('town') is-invalid @enderror "
                                                            min="0" wire:model='formData.opportunity.town'
                                                            placeholder="Town" />
                                                        @error('town')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                    ...
                                    form-control-custom-1  @error('country') is-invalid @enderror "
                                                            min="0" wire:model='formData.opportunity.country' />
                                                        @error('country')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                    ...
                                    form-control-custom-1  @error('experience') is-invalid @enderror "
                                                            wire:model='formData.opportunity.experience'
                                                            placeholder="Exp" />
                                                ...
                                                <div class="col-lg-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.schooling'
                                                ...
                                                <div class="col-lg-1">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.schedules'
                                                            placeholder="Hor" />
                                                        @error('schedules')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-lg-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.mobility'
                                                ...
                                                <div class="col-lg-1">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.permission'
                                                            placeholder="Per" />
                                                        @error('permission')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-lg-1">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.type'
                                                            placeholder="Type" />
                                                        @error('type')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-lg-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.vehicle'
                                                ...
                                                <div class="col-lg-2">
                                                    <div>
                                                        ...
                                                        <input
                                                            type="date"
                                                            wire:model='formData.opportunity.job_offer_date'
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.skill_one'
                                                            placeholder="Skill 1" />
                                                        @error('skill_one')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.skill_two'
                                                            placeholder="Skill 2" />
                                                        @error('skill_two')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.skill_three'
                                                            placeholder="Skill 3" />
                                                        @error('skill_three')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.other_one'
                                                            placeholder="Autres" />
                                                        @error('other_one')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.remarks_two'
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            wire:model='formData.opportunity.job_start_date'
                                                    ...
                                                    <div class="invo">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            wire:model='formData.opportunity.invoice_date'
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.gross_salary'
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.bonus_1'
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.bonus_2'
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.bonus_3'
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            wire:model='formData.opportunity.other_two'
                                                            placeholder="Autres" />
                                                        @error('other_two')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
