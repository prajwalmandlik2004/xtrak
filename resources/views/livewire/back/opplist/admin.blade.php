    ...
    <div class="row">
        <div style="margin-bottom:-20px; margin-top:-10px;" class="col-md-12">
            <div class="d-flex align-items-center">
                <div class="p-1">
                    <h5 style="color:black;background-color:yellow; padding:12px; width:100%; margin-bottom:0;">CDT_OPPlist</h5>
                </div>
                <div class="p-1">
                    <label for="trgcode">CDTcode</label>
                ...
                <div class="p-1">
                    <label for="ctc-fonction">Fonction</label>
        ...
        <div class="card-footer">
            <div class="button-group-main">
                <div class="button-group-left-main">
                    <a href="/opportunity">
                        <button style="background:#6F61C0;color:white;" type="button" class="btn btn-close1" onclick="openModal()">NewOPP</button>
                    </a>
                    <div class="one">
