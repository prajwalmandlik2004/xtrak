                    ...
                    <form wire:submit.prevent="updateForm">
                        <div class="form-row">
                            <div class="form-group date-field">
                                <label>Date</label>
                                <input type="date" class="form-control1" wire:model="formData.date_ctc">
                                @error('formData.date_ctc') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div class="form-group company-field">
                                <label>Company</label>
                                <input type="text" class="form-control1" wire:model="formData.company_ctc">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group date-field">
                                <label>Civ</label>
                                <input type="text" class="form-control1" wire:model="formData.civ">
                            </div>
                            <div class="form-group objet-field">
                                <label>First Name</label>
                                <input type="text" class="form-control1" wire:model="formData.first_name">
                                @error('formData.first_name') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>Last Name</label>
                                <input type="text" class="form-control1" wire:model="formData.last_name">
                                @error('formData.last_name') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group company-field">
                                <label>Position</label>
                                <input type="text" class="form-control1" wire:model="formData.function_ctc">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group objet-field">
                                <label>STD</label>
                                <input type="text" class="form-control1" wire:model="formData.std_ctc">
                            </div>
                            <div class="form-group date-field">
                                <label>Ext</label>
                                <input type="text" class="form-control1" wire:model="formData.ext_ctc">
                            </div>
                            <div class="form-group objet-field">
                                <label>LD</label>
                                <input type="text" class="form-control1" wire:model="formData.ld">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group objet-field">
                                <label>Cell</label>
                                <input type="text" class="form-control1" wire:model="formData.cell">
                            </div>
                            <div class="form-group mail-field">
                                <label>Mail</label>
                                <input type="text" class="form-control1" wire:model="formData.mail">
                            </div>
                            <div class="form-group comment-field">
                                <label>Note(s)</label>
