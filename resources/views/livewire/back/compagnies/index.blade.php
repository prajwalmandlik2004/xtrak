<div>
    ...
    @include('components.breadcrumb', [
        'title' => 'Listes des sociétes',
        'breadcrumbItems' => [
            ['text' => 'sociétes', 'url' => '#'],
            ['text' => 'Listes', 'url' => Route('compagnies.index')],
        ],
    ])
    <!-- end page title -->
    <div class="d-flex">
            ...
            <div class="table-responsive">
                <table class="table table-striped  table-hover table-hover-primary align-middle table-nowrap mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:dblclick.prevent="openModal('{{ $compagny->id }}')">
    ...
    <x-modal>
        <x-slot name="title">
            {{ $isUpdate ? 'Modification de l\a societé' : 'Ajout de l\a societé' }}
        </x-slot>
        <x-slot name="body">
