<div>
    ...
    @include('components.breadcrumb', [
        'title' => 'Listes des états',
        'breadcrumbItems' => [
            ['text' => 'états', 'url' => '#'],
            ['text' => 'Listes', 'url' => Route('candidate_states.index')],
        ],
    ])
    <!-- end page title -->
    <div class="d-flex">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped  table-hover table-hover-primary align-middle table-nowrap mb-0">
                    ...
                    <tbody>
                        @forelse ($candidateStates as $candidateStatut)
    ...
    <div class="row g-0 text-center text-sm-start align-items-center mb-4">
        <!-- end col -->
        {{ $candidateStates->links() }}
    </div><!-- end row -->


    <x-modal>
        <x-slot name="title">
            {{ $isUpdate ? 'Modification de l\'état' : 'Ajout de l\'état' }}
        </x-slot>
        <x-slot name="body">
