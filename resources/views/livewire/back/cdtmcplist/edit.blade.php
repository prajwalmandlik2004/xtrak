                    ...
                    <form wire:submit.prevent="updateForm">
                        <div class="form-row">
                            <div class="form-group date-field">
                                <label>Date</label>
                                <input type="date" class="form-control1" wire:model="formData.opportunity.date_mcp">
                                @error('date_mcp') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>MCPcode</label>
                                <input type="text" class="form-control1" wire:model="formData.opportunity.mcp_code" readonly>
                                @error('mcp_code') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>Designation</label>
                                <input type="text" class="form-control1" wire:model="formData.opportunity.designation">
                                @error('designation') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group objet-field">
                                <label>Object</label>
                                <input type="text" class="form-control1" wire:model="formData.opportunity.object">
                            </div>
                            <div class="form-group objet-field">
                                <label>Tag Source</label>
                                <input type="text" class="form-control1" wire:model="formData.opportunity.tag_source">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group objet-field">
                                <label>Message</label>
                                <input type="text" class="form-control1" wire:model="formData.opportunity.message">
                            </div>
                            <div class="form-group objet-field">
                                <label>Tool</label>
                                <select class="form-control1" wire:model="formData.opportunity.tool">
                            ...
                            <div class="form-group objet-field">
                                <label>Remarks</label>
                                <input type="text" class="form-control1" wire:model="formData.opportunity.remarks">
                            </div>
                            <div class="form-group comment-field">
                                <label>Note(s)</label>
                                <textarea class="form-control2" wire:model="formData.opportunity.notes"></textarea>
                            </div>
                        </div>
