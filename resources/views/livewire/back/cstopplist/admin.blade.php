<div>
    ...
    'breadcrumbItems' => [['text' => 'ADM', 'url' => ''] ,['text' => 'Landing', 'url' => '/landing'] ,['text' => 'Views', 'url' => ''] ,['text' => 'CSTvue', 'url' => '/cstdashboard'] , ['text' => 'CST_OPPlist', 'url' => '/cstopplist']],
    ])
                ...
                <div class="p-1 flex-grow-1">
                    ...
                    <div class="button-group-main">
                        <div class="button-group-left-main">
                            <h5 style="margin-left:-22px; background-color:#00FF9C; border-radius:5px; color:black;padding:12px;margin-top:-2px">CST_OPPlist</h5>
                            @if($links->count() == 1)
                            @foreach($links as $link)
                            <div class="mt-1">
                                <input style="width:90px; padding:5px;" type="text" placeholder="{{ $link->opportunity->cst_code ?? '--' }}"></input>
                            </div>
                            <div class="mt-1">
                                <input style="width:90px;padding:5px;" type="text" placeholder="{{ $link->opportunity->first_name?? '--' }}"></input>
                            </div>
                            <div class="mt-1">
                                <input style="width:90px;padding:5px;" type="text" placeholder="{{ $link->opportunity->last_name ?? '--' }}"></input>
                            </div>
                            @endforeach
                            @else
                            <div class="mt-2">
                        ...
                        <table
                            ...
                            <thead class="text-black sticky-top">
                                <tr>
                                    ...
                                    <th class="cdt_col" scope="col" style="background-color:#6F61C0;color:white;">OPPdate</th>
                                    <!-- <th class="reg_col" scope="col" style="background-color:#F9C0AB;">OPPcode</th> -->
                                    <th class="reg_col" scope="col" style="background-color:#6F61C0;color:white;">Job description</th>
                                    <th class="reg_col" scope="col" style="background-color:#6F61C0;color:white;">TRGcode</th>
                                    <th class="reg_col" scope="col" style="background-color:#6F61C0;color:white;">Company name</th>
                                    <th class="reg_col" scope="col" style="background-color:#6F61C0;color:white;">Status</th>
                                    <th class="reg_col" scope="col" style="background-color:#6F61C0;color:white;">Link</th>
                                    <th class="reg_col" scope="col" style="background-color:#6F61C0;color:white;">Actions</th>
