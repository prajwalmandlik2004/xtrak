                    ...
                    <div class="button-group-main">
                        <div class="button-group-left-main">
                            ...
                            <div class="mt-1">
                                ...
                                <input style="width:70px; padding:5px;" type="text" placeholder="CSTcode"></input>
                            </div>
                            <div class="mt-1">
                        ...
                        <table
                            ...
                            <thead class="text-black sticky-top">
                                <tr>
                                    ...
                                    <th class="cdt_col" scope="col" style="background-color:#F9C0AB;">OPPdate</th>
                                    <th class="reg_col" scope="col" style="background-color:#F9C0AB;">LinkDate</th>
                                    <th class="reg_col" scope="col" style="background-color:#F9C0AB;">Job description</th>
                                    <th class="reg_col" scope="col" style="background-color:#F9C0AB;">TRGcode</th>
                                    <th class="reg_col" scope="col" style="background-color:#F9C0AB;">Company name</th>
