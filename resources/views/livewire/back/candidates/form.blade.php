                                ...
                                <div>
                                    ...
                                    <select class="form-control @error('title') is-invalid @enderror "
                                        ...
                                        @foreach ($candidateTitles as $candidateTitle)
                                            <option value="{{ $candidateTitle }}">{{ $candidateTitle }}</option>
                                        @endforeach
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control @error('company') is-invalid @enderror "
                                        wire:model.live='company' placeholder="Veuillez entrer le nom de la société" />
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror "
                                        wire:model.live='phone' placeholder="Veuillez entrer le numéro de télépone" />
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input type="text" class="form-control @error('phone_2') is-invalid @enderror "
                                        wire:model.live='phone_2' placeholder="Veuillez entrer la société" />
                            ...
                            <div class="col-md-4">
                                <div>
                                    <label for="vancancy-Input" class="form-label">CP/Dpt <span
                                            class="text-danger">*</span></label>
                                    <input type="number"
                                        class="form-control @error('postal_code') is-invalid @enderror " min="0"
                                        wire:model.live='postal_code' placeholder="Veuillez entrer la boîte postal" />
                                    @error('postal_code')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
