<div>
    ...
    <div class="d-flex">
        <div class="p-2 flex-grow-1">
            <a href="{{ route('candidates.create') }}" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i>
                Nouveau</a>
        </div>
        <div class="p-2">
            ...
            <div class="col-xxl-4 col-sm-6 project-card">
                <div class="card mecustom-card">
                    <div class="card-body">
                                    ...
                                    <div class="d-flex gap-1 align-items-center my-n2">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <button class="dropdown-item" wire:click="confirmDelete('{{ $candidate->first_name.' '.$candidate->last_name }}', '{{ $candidate->id }}')" 
                        ...
                        <div class="dl mt-2">
                            <dt>Poste: </dt>
                            <dd>{{ $candidate->position ?? 'non definie'}}
                            </dd>
                            <dt>Société: </dt>
