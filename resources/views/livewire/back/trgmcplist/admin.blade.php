<div>
    ...
    'breadcrumbItems' => [['text' => 'ADM', 'url' => ''] ,['text' => 'Landing', 'url' => '/landing'] ,['text' => 'Views', 'url' => ''] ,['text' => 'TRGvue', 'url' => '/trgdashboard'] , ['text' => 'TRG_MCPlist', 'url' => '/trgmcplist']],
    ])
                ...
                <div class="p-1 flex-grow-1">
                    ...
                    <div class="button-group-main">
                        <div class="button-group-left-main">
                            <h5 style="margin-left:-22px; background-color:#DBDBDB; border-radius:5px; color:black;padding:12px;margin-top:-2px">TRG_MCPlist</h5>
                            @if($links->count() == 1)
                        ...
                        <table
                            ...
                            <thead class="text-black sticky-top">
                                <tr>
                                    ...
                                    <th class="reg_col" scope="col" style="background-color:#7D0A0A;color:white;">TRGcode</th>
                                    <th class="reg_col" scope="col" style="background-color:#7D0A0A;color:white;">CampDesignation</th>
