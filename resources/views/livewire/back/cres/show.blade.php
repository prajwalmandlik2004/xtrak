                            ...
                            <div class="d-flex">
                                ...
                                <div class="p-2 flex-fill">
                                    ...
                                    <h6><span class="text-muted fw-normal">Date:
                                        </span><span>{{ $candidate->cre_created_at ? \Carbon\Carbon::parse($candidate->cre_created_at)->format('d-m-Y') : '--' }}</span>
                                    </h6>
                                </div>
                            </div>
                            <div class=" mt-4 ms-1">
                                <div>
                                    <span class="fs-20"><strong>COMPTE RENDU D'ENTRETIEN DE
                                            {{ $candidate->civ->name ?? '---' }}. </strong></span>
                                    <span
                                        class="custom-badge bg-light-subtle text-body fs-20 text-wrap">{{ $candidate->first_name }}
                                        {{ $candidate->last_name }}</span>
                                </div>
                                <div class="d-flex justify-content-center mt-2">
                                    <span class="fs-20"><strong>POSTE : </strong></span>
                                    <span
                                        class="custom-badge bg-light-subtle text-body fs-20 text-wrap">{{ $candidate->position->name }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="custom-card-body">
                            <ol>
                                @forelse ($cres as $cre)
                                    <li>
                                        ...
                                        <span
                                            class="custom-badge bg-light-subtle text-body fs-13 text-wrap">{{ $cre->response }}</span>
                                    </li>
                                @empty
                            ...
                            <div class="hstack gap-2 justify-content-end d-print-none mt-5">
                                <button class="custom-btn btn-primary"><i
