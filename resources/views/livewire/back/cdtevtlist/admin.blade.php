        ...
        <div style="margin-bottom:-20px; margin-top:-10px;" class="col-md-12">
            <div class="d-flex">
                <div class="p-1 flex-grow-1">
                    <h5 style="margin-left:-5px; color:black;background-color:yellow; padding:12px; width:11%; margin-bottom:0;">CDT_EVTlist</h5>
                </div>
            </div>
        </div>
                        ...
                        <table
                            ...
                            <thead class="text-black sticky-top">
                                <tr>
                                    ...
                                    <th class="reg_col" scope="col" style="background-color:#F9C0AB;">StatutCDT</th>
