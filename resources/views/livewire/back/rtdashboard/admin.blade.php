                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <thead class="text-white sticky-top">
                                <tr>
                                    <!-- <th style="width:30px;background-color: red;" scope="col"><input type="checkbox" id="select-all-checkbox" class="candidate-checkbox"
                                    ...
                                    <th class="soci_col" scope="col" wire:click="sortBy('last_name')" style="background-color: red;">
                                        Subject
                                    </th>
                                    <th class="ville_col" scope="col" style="background-color: red;">Position</th>
                                    <th class="ref_col" scope="col" style="background-color: red;">Re.</th>
                                    <th class="cpdpt_col" scope="col" style="background-color: red;">Problems</th>
                                    <th class="reg_col" scope="col" style="background-color: red;">Corrective Actions</th>
                                    <th class="ville_col" scope="col" style="background-color: red;">Delay</th>
                                    <th class="ref_col" scope="col" style="background-color: red;">Remarks</th>
                                    <th class="cpdpt_col" scope="col" style="background-color: red;">Priority</th>
                                    <th class="reg_col" scope="col" style="background-color: red;">Status</th>
                                    <th class="ville_col" scope="col" style="background-color: red;">Note One</th>
                                    <th class="ref_col" scope="col" style="background-color: red;">Note Two</th>
                                    <th class="cpdpt_col" scope="col" style="background-color: red;">Rk</th>
                                    <th class="reg_col" scope="col" style="background-color: red;">Vol</th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        <div id="evtModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 style="background:red;width:18%;padding:7px;text-align:center">CST_EVTform</h2>
                </div>
                <div class="icons-row">
                    <div class="icon-item">
