<div>
    ...
    'breadcrumbItems' => [['text' => 'ADM', 'url' => ''] ,['text' => 'Landing', 'url' => '/landing'] ,['text' => 'Views', 'url' => ''] ,['text' => 'CTCvue', 'url' => '/ctcdashboard'] , ['text' => 'CTC_EVTlist', 'url' => '/ctcevtlist']],
    ])
                ...
                <div class="p-1 flex-grow-1">
                    ...
                    <div class="button-group-main">
                        <div class="button-group-left-main">
                            <h5 style="margin-left:-22px; background-color:#06D001; border-radius:5px; color:black;padding:12px;margin-top:-2px">CTC_EVTlist</h5>
                            <div class="mt-1">
                                <!-- <label for="trgcode">OPPcode</label> -->
                                <input style="width:70px; padding:5px;" type="text" placeholder="CTCcode"></input>
                            </div>
                            <div class="mt-1">
