                    ...
                    <form wire:submit.prevent="updateForm">
                        <div class="form-row">
                            <div class="form-group date-field">
                                <label>Date</label>
                                <input type="date" class="form-control1" wire:model="formData.creation_date">
                            </div>
                            <div class="form-group type-field">
                                <label>Auth</label>
                                <input type="text" class="form-control1" wire:model="formData.auth">
                            </div>
                            <div class="form-group objet-field">
                                <label>Company</label>
                                <input type="text" class="form-control1" wire:model="formData.company">
                            </div>
                            <div class="form-group date-field">
                                <label>Std</label>
                                <input type="text" class="form-control1" wire:model="formData.standard_phone">
                            </div>
                            <div class="form-group date-field">
                                <label>Url</label>
                                <input type="text" class="form-control1" wire:model="formData.website_url">
                            </div>
                            <div class="form-group date-field">
                                <label>TRGcode</label>
                        ...
                        <div class="form-row">
                            <div class="form-group objet-field">
                                ...
                                <input type="text" class="form-control1" wire:model="formData.address">
                            </div>
                            <div class="form-group objet-field">
                                <label>Address2</label>
                                <input type="text" class="form-control1" wire:model="formData.address_one">
                            </div>
                            <div class="form-group date-field">
                                <label>CP/Dpt</label>
                                <input type="text" class="form-control1" wire:model="formData.postal_code_department">
                            </div>
                            <div class="form-group date-field">
                                <label>Area</label>
                                <input type="text" class="form-control1" wire:model="formData.region">
                            </div>
                            <div class="form-group date-field">
                                <label>Town</label>
                                <input type="text" class="form-control1" wire:model="formData.town">
                            </div>
                            <div class="form-group date-field">
                                <label>Country</label>
                                <input type="text" class="form-control1" wire:model="formData.country">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group date-field">
                                <label>CA (K)</label>
                                <input type="text" class="form-control1" wire:model="formData.ca_k">
                            </div>
                            <div class="form-group date-field">
                                <label>Staff</label>
                                <input type="text" class="form-control1" wire:model="formData.employees">
                            </div>
                            <div class="form-group date-field">
                                <label>Activity</label>
                                <input type="text" class="form-control1" wire:model="formData.activity">
                            </div>
                            <div class="form-group date-field">
                                <label>Type</label>
                                <input type="text" class="form-control1" wire:model="formData.type">
                            </div>
                            <div class="form-group objet-field">
                                <label>SIRET</label>
                                <input type="text" class="form-control1" wire:model="formData.siret">
                            </div>
                            <div class="form-group objet-field">
                                <label>RCS</label>
                                <input type="text" class="form-control1" wire:model="formData.rcs">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group date-field">
                                ...
                                <input type="text" class="form-control1" wire:model="formData.filiation">
                            </div>
                            <div class="form-group date-field">
                                <label>OF</label>
                                <input type="text" class="form-control1" wire:model="formData.off">
                            </div>
                            <div class="form-group date-field">
                                <label>Form</label>
                                <input type="text" class="form-control1" wire:model="formData.legal_form">
                            </div>
                            <div class="form-group objet-field">
                                <label>VAT#</label>
                                <input type="text" class="form-control1" wire:model="formData.vat_number">
                            </div>
                            <div class="form-group objet-field">
                                <label>TRG Status</label>
                                <input type="text" class="form-control1" wire:model="formData.trg_status">
                            </div>
                        </div>
                        ...
                        <div class="comment-section">
                            <div class="form-group comment-field">
                                ...
                                <textarea class="form-control2" wire:model="formData.remarks"></textarea>
                            </div>
                            <div class="form-group comment-field">
                                <label>Note(s)</label>
                            ...
                            <div class="right-section">
                                <div class="next-ech-row">
                                    <div class="form-group next-field">
                                        <label>LM Sent.</label>
                                        <input type="text" class="form-control1" wire:model="formData.last_modification_date">
                                    </div>
                                    <div class="form-group ech-field">
                                        <label>Prio.</label>
                                        <input type="text" class="form-control1" wire:model="formData.priority">
                                    </div>
                                </div>
                            </div>
                        </div>
